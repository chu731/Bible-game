...
import com.company.Sprite.RedSeaSprite.Anubis;
import com.company.Sprite.RedSeaSprite.Cat;
import com.company.Sprite.RedSeaSprite.Pharaoh;
                ...
                for (int i = mosesPoint.y; i > 0; i--) {
                    for (Sprite s:gameView.getElements()) {
                        if (s.getRelativePosition() != null && s.getRelativePosition().x == mosesPoint.x && s.getRelativePosition().y == i) {
                            ...
                            if (s instanceof Anubis || s instanceof Bug || s instanceof Frog || s instanceof Pharaoh) {
                                s.setNullPosition();
                                repaint();
                                return;
                            }
